...
from apps.main.services import send_registration_success_email
...
def login_view(request):
    ...
    return render(request, 'main/auth/login/page.html', context)
...
def register_select_view(request):
    return render(request, 'main/auth/register/page.html')
...
def learner_register_view(request):
    ...
    return render(request, 'main/auth/register/learner.html', context)
...
def teacher_register_view(request):
    ...
    return render(request, 'main/auth/register/teacher.html', context)
