...
def game_task_session_waiting_view(request, pk, session_id):
    ...
    return render(request, 'app/dashboard/teacher/game_tasks/game_task/session/waiting/page.html', context)
...
def game_task_session_participants_fragment(request, pk, session_id):
    ...
    return render(request, 'app/dashboard/teacher/game_tasks/game_task/session/_session_participants.html', context)
...
def game_task_session_start_view(request, pk, session_id):
    ...
    if request.method != 'POST':
        return redirect('teacher:session_waiting', session_id=session.pk)
