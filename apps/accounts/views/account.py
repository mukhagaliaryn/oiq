...
from apps.accounts.forms.account import AccountDeleteForm, TeacherEditForm, UserEditForm
...
def account_edit_view(request):
    ...
    if request.method == 'POST' and 'remove_avatar' in request.POST:
        ...
        return redirect('accounts:account-edit')
...
def account_settings_view(request):
    ...
    return render(request, 'accounts/account/settings.html', {'form': form})
    ...
    if request.method == 'POST':
        ...
        if action == 'change_password':
            ...
            if password_form.is_valid():
                ...
                return redirect('accounts:account-security')
