...
from apps.accounts.forms.auth import LearnerRegisterForm
from apps.accounts.forms.auth import LoginForm
from apps.accounts.forms.auth import TeacherRegisterForm
from apps.accounts.services import create_learner_user
from apps.accounts.services import create_teacher_user
from apps.accounts.services import get_user_redirect_url
from apps.accounts.services import save_user_session
from apps.accounts.services.emails import send_registration_success_email
...
def login_view(request):
    ...
    return render(request, 'accounts/auth/login/page.html', context)
...
def register_select_view(request):
    return render(request, 'accounts/auth/register/page.html')
...
def learner_register_view(request):
    ...
    return render(request, 'accounts/auth/register/learner.html', context)
...
def teacher_register_view(request):
    ...
    return render(request, 'accounts/auth/register/teacher.html', context)
